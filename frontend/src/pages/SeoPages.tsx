...
const getArticleSchema = (headline: string) => ({
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": headline,
...
const SeoPageTemplate = ({
    title, description, canonical, schema, h1, path
}: {
    title: string, description: string, canonical: string, schema?: object, h1: string, path: string
}) => (
    <div style={{ padding: '4rem 2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto', color: '#fff', backgroundColor: '#0a0a0a', minHeight: '100vh' }}>
        ...
        <h1 style={{ fontSize: '2rem', marginBottom: '1rem', color: '#B3FE00' }}>{h1}</h1>
...
export const BlogEcosistemaDigital = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Qué es un Ecosistema Digital y por qué tu negocio lo necesita")}
...
export const BlogInfoproductos = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Cómo Vender Infoproductos Online en Argentina: Guía 2026")}
...
export const BlogAgenciaCordoba = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Agencia de Marketing Digital en Córdoba: Cómo elegirla")}
...
export const BlogMetaAdsCoaches = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Meta Ads para Coaches y Mentores: Guía Paso a Paso")}
...
export const BlogMarcaPersonal = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Cómo Posicionar tu Marca Personal en Google")}
...
export const BlogInfoproductoresLatam = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Marketing Digital para Infoproductores en LATAM")}
...
export const BlogAgenciaFreelancer = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Agencia de Marketing vs Freelancer: Qué Conviene")}
...
export const BlogLeadsCalificados = () => <SeoPageTemplate
    ...
    schema={getArticleSchema("Cómo Generar Leads Calificados para Servicios Digitales")}
